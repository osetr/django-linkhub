...
urlpatterns = [
    ...
    path("home/playlist/<target>", ShowPlaylistsView.as_view(), name="show_playlists_n"),
    ...
    path("home/playlist/add_link/<pk>/", AddNewLinkView.as_view(), name="add_new_link_n"),
    ...
    path(r"^ajax/remove_playlist/<pk>$", remove_playlist_ajax, name="remove_playlist_n"),
    path(r"^ajax/restore_playlist/<pk>$", restore_playlist_ajax, name="restore_playlist_n"),
